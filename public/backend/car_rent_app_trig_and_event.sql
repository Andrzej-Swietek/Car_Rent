...
--
-- Host: localhost:8889
-- Generation Time: Dec 01, 2021 at 08:53 PM
...
(2, 4, 2, '', '', 'cancelled', '1'),
(3, 2, 4, '2021-12-05', '2021-11-27', 'cancelled', '10'),
(4, 2, 5, '2021-10-30', '2021-10-28', 'cancelled', '5'),
(5, 2, 1, '2021-10-07', '2021-10-11', 'cancelled', '5');
...
(4, 2, 2, '2021-12-29', '2021-10-20', 'Accepted', '1'),
(8, 4, 2, '2021-11-10', '2021-11-24', 'Accepted', '1'),
(10, 4, 2, '2021-12-02', '2021-11-11', 'Pending', '1'),
(11, 2, 1, '2021-12-15', '2021-12-16', 'Accepted', '4');
...
-- Events
--
CREATE DEFINER=`root`@`localhost` EVENT `Time` ON SCHEDULE EVERY 1 MINUTE STARTS '2021-12-01 18:33:40' ENDS '2021-12-31 18:33:40' ON COMPLETION NOT PRESERVE ENABLE DO UPDATE Time SET Time.time=CURRENT_TIMESTAMP() WHERE ID=1$$
